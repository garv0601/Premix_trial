 ...
 *                                    prefill the Razorpay checkout (never sensitive/secret).
 * @returns {Promise<object>} Backend response ({ order, keyId, mock? }) where
 *                            order is the Razorpay order object ({ id, amount, currency, ... })
 */
